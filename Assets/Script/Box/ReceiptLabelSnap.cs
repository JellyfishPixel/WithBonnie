...
public class ReceiptLabelSnap : MonoBehaviour, IInteractable
{
  ...
  )
    {
        ...
        var currentBox = holdingBox != null ? holdingBox : BoxWorkArea.Instance.CurrentBox;
    ...
    {
        isHeld = true;
        holdingBox = BoxWorkArea.Instance.CurrentBox;
        // 🔊 Pickup Label SFX
