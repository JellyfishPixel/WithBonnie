...
public class EconomyManager : MonoBehaviour
{
    ...
    [ContextMenu("DEV/Add +10 All Box Stock")]
    public void DevAddAllBoxes()
    {
        boxStockS += 10;
        boxStockM += 10;
        boxStockL += 10;
        ...
        Debug.Log("[DEV] Added +10 to all box stocks");
    }

    [ContextMenu("DEV/Add +10 All Tape Rolls")]
    public void DevAddAllTapeRolls()
    {
        AddTapeRoll(TapeColor.Red, 10);
        AddTapeRoll(TapeColor.Blue, 10);
        AddTapeRoll(TapeColor.Green, 10);

        Debug.Log("[DEV] Added +10 rolls to all tape colors");
    }

    [ContextMenu("DEV/Add +10 All Bubble Purchases")]
    public void DevAddAllBubbles()
    {
        AddBubble(BubbleType.Basic, 10);
        AddBubble(BubbleType.Strong, 10);
        AddBubble(BubbleType.Ice, 10);

        Debug.Log("[DEV] Added +10 purchases to all bubble types");
    }

    [ContextMenu("DEV/Add +10 EVERYTHING")]
    public void DevAddEverything()
    {
        DevAddAllBoxes();
        DevAddAllTapeRolls();
        DevAddAllBubbles();

        Debug.Log("[DEV] Added +10 to ALL stocks");
    }
    void Update()
    {
#if UNITY_EDITOR
    ...
    public EconomySaveData Capture()
    {
        return new EconomySaveData
        {
            ...
            boxM = boxStockM,
            boxL = boxStockL,
            boxCold = boxStockCold,
            boxWaterM = boxStockWaterM,
            boxWaterL = boxStockWaterL,

            tapeRed = tapeUsesRed,
            tapeBlue = tapeUsesBlue,
            tapeGreen = tapeUsesGreen,

            bubbleBasic = bubbleUsesBasic,
            bubbleStrong = bubbleUsesStrong,
            bubbleIce = bubbleUsesIce
        };
    }

    public void Restore(EconomySaveData d)
    {
        currentDay = d.day;
        cashToday = d.cashToday;
        bankBalance = d.bankBalance;

        boxStockS = d.boxS;
        boxStockM = d.boxM;
        boxStockL = d.boxL;
        boxStockCold = d.boxCold;
        boxStockWaterM = d.boxWaterM;
        boxStockWaterL = d.boxWaterL;

        tapeUsesRed = d.tapeRed;
        tapeUsesBlue = d.tapeBlue;
        tapeUsesGreen = d.tapeGreen;

        bubbleUsesBasic = d.bubbleBasic;
        bubbleUsesStrong = d.bubbleStrong;
        bubbleUsesIce = d.bubbleIce;
